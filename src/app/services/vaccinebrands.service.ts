...
export class vaccineBrandsService extends BaseService {

  private readonly API_VACCINE = `${environment.BASE_URL}VaccineBrand`

  constructor(
    protected http: HttpClient
  ) { super(http); }

  addVaccineBrands(data): Observable<any> {
...
//   }
  ...
  getVaccineBrands() : Observable<any> {
